// lib/contact_info_screen.dart (VERSION NSHYA YIHUTA)
...
class _ContactInfoScreenState extends State<ContactInfoScreen> {
  ...
  // Ntabwo tugikeneye _isLoading na _userData hano
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // <<< IMPINDUKA NYAMUKURU IRI HANO: Ubu dukoresha FutureBuilder >>>
