...
class _LastSeenSettingsScreenState extends State<LastSeenSettingsScreen> {
    ...
    try {
      ...
      if(mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(lang.t('privacy_saved')), // "Ibyahinduwe byabitswe..."
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(lang.t('last_seen_title')), // "Igihe Waherukiyeho"
      ...
      body: _currentSelection == null
          ...
          : ListView(
              children: [
                _buildSectionHeader(context, lang.t('last_seen_header')), // "Ninde ushobora..."
                _buildRadioOption(
                  context,
